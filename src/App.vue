<template>
  <div id="app">
    <v-app id="inspire">
      ...
      <!-- Menu -->
      <v-app-bar app extension flat width="100%">
      ...
      <v-main>
        ...
        <v-container class="my-10">
          <v-row no-gutters>
            ...
            >
              <v-img src="src/img/foto_notebook.png" max-width="400"></v-img>
            </v-col>
          </v-row>
            ...
            <v-col md-col="4" sm-col="1" class="">
              <v-card class="full-height rounded-lg" style="height: 400px">
                ...
                >
                  ...
                  <h5 class="font-weight-light">Datas comemorativas</h5>
            ...
            <v-col md-col="4" sm-col="1">
              ...
              >
                ...
                >
                  ...
                  <h5 class="font-weight-light">Datas comemorativas</h5>
                  <h5 class="font-weight-light">Cupom primeiro cadastro</h5>
                  <h5 class="font-weight-light">Cupom de aniversário</h5>
            ...
            <v-col md-col="4" sm-col="1" class="">
              <v-card class="full-height rounded-lg" style="height: 400px">
                ...
                >
                  ...
                  <h5 class="font-weight-light">Página HTML para formulário</h5>
                  <h5 class="font-weight-light">
